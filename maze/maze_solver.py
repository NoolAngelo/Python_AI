...
class Node:
    ...
    """
    def __init__(self, state: Tuple[int, int], parent: Optional['Node'], 
                 action: Optional[str], cost: int = 0) -> None:
        self.state = state
        self.parent = parent
        self.action = action
        self.cost = cost
...
class Maze:
    ...
    def output_image(self, filename: str, show_explored: bool = False, show_solution: bool = True) -> None:
        """
